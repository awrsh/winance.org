    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: {
                    "default": "یک فایل را به اینجا بکشید و یا برای انتخاب فایل کلیک کنید.",
                    replace: "برای انتخاب فایل جایگزین کلیک کنید.",
                    remove: "حذف",
                    error: "خطا در دریافت فایل!"
                },
                error: {
                    fileSize: "حجم فایل بسیار بالا می باشد. حداکثر: ({{ value }}).",
